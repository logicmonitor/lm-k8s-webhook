...
Common labels
*/}}
{{- define "lm-webhook.labels" -}}
helm.sh/chart: {{ include "lm-webhook.chart" . }}
{{ include "lm-webhook.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "lm-webhook.selectorLabels" -}}
...
*/}}
{{- define "lm-webhook.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "lm-webhook.fullname" .) .Values.serviceAccount.name }}
{{- else }}
